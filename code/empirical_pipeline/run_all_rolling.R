...
source("code/empirical_pipeline/01b_build_rolling_panel.R")
source("code/empirical_pipeline/05b_table4_figure3_rolling.R")
source("code/empirical_pipeline/06b_within_season_reallocation_rolling.R")
source("code/empirical_pipeline/07b_behavioral_heterogeneity_rolling.R")
source("code/empirical_pipeline/08b_state_contingent_activation_rolling.R")
source("code/empirical_pipeline/09b_seasonal_overlap_rolling.R")
