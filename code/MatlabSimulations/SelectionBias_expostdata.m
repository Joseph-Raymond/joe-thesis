...
for i = 1:numIterations
    ...
    %this yet
    [results,choice_strat] = select_oneORthree_fishery(a1,a2,a3,b1,b2,b3,c1,c2,c3,eps1,eps2,eps3,fc1,fc2,fc3,i,results,results_A,results_B,results_C,results_ABC);
    [results,firstyear_strat1] = select_one_fishery(a1,a2,a3,b1,b2,b3,c1,c2,c3,eps1,eps2,eps3,fc1,fc2,fc3,i,results,results_A,results_B,results_C,results_AB,results_AC,results_BC,results_ABC);
    ...
    if choice_strat == "A" | choice_strat == "B" | choice_strat == "C"
        ...
        for j = 1:numYears
            ...
            a2_temp = a2 - 2 + 4 * rand;
            a3_temp = a3 - 2 + 4 * rand;
            [choice_results,~] = oneYearChoice_fs(choice_strat,a1_temp,a2_temp,a3_temp,b1,b2,b3,c1,c2,c3,eps1,eps2,eps3,fc1,fc2,fc3,j,choice_results,results_A,results_B,results_C,results_AB,results_AC,results_BC,results_ABC);
            %store the revenue
    ...
    elseif choice_strat == "ABC"
        ...
        for j = 1:numYears
            ...
            a2_temp = a2 - 2 + 4 * rand;
            a3_temp = a3 - 2 + 4 * rand;
            [choice_results,~] = oneYearChoice_fs(choice_strat,a1_temp,a2_temp,a3_temp,b1,b2,b3,c1,c2,c3,eps1,eps2,eps3,fc1,fc2,fc3,j,choice_results,results_A,results_B,results_C,results_ABC);
            %store the revenue
            rev_store(j,1) = choice_results(j,4);
            %store the simpson index
            rev_store(j,2) = choice_results(j,5);
...
xlabel("10yr HHI")
ylabel("Income CV")
title("Income CV / 10-year HHI (treated given treated)")
cb = colorbar(); 
ylabel(cb,'Mean Annual Revenue (10yr)','FontSize',12,'Rotation',270)
